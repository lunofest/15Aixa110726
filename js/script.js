...
function updateTimer() {
    const targetDate = new Date("july 11, 2026 21:00:00").getTime();
...
function initPlaylistForm() {
    ...
    const WHATSAPP_NUMBER = '543815396076';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const recipientNumber1 = '543815396076'; // Número para el primer botón
    ...
    function sendMessage(phoneNumber) {
        ...
        let mensaje = `*Presencia:* ${attendanceStatus.value}\n*Nombre y Apellido:* ${userName}`;
        if (userMessage) {
            mensaje += `\n*Mensaje:* ${userMessage}`;
        }
