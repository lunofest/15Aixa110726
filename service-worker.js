const CACHE_NAME = 'cache-v23'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v23',
    'estilos/styles.css?v23',
    'estilos/mediaQueries.css?v23',
    'javascript/script.js?v23',
